export default function SpotlightOverlay({ targetRect }: { targetRect: DOMRect | null }) {
  ...
  const maskStyle: React.CSSProperties = {
    ...
    zIndex: 9800, // Lower than DemoStep but higher than most other elements
  ...
  // Adding the overlay-spotlight class for potential CSS targeting
  return <div style={maskStyle} className="overlay-spotlight" />;
}
