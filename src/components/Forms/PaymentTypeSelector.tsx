export type PaymentTypeOption = "BILL" | "DEBT" | "SPLIT_RECURRING" | "SPLIT_SAVEUP";
...
export default function PaymentTypeSelector({
  ...
  return (
    <div className="flex flex-col items-center gap-4 w-full">
      <h3 className="text-lg text-my-white-light mb-2">What type of payment?</h3>
      ...
      >
        ...
        <p className="text-xs">Rent, Mortgage, etc...<br /> Split by paycheck.</p>
      </button>
      ...
      >
        ...
        <p className="text-xs">Pay for a future purchase.<br /> Split by paycheck.</p>
      </button>
      ...
      {onBack && (
        <button
          type="button"
          onClick={onBack}
          className="w-[80%] max-w-[20rem] p-2 rounded-md text-my-white-dark border border-my-red-dark hover:bg-my-red-dark hover:text-my-white-light mt-4 transition-colors"
        >
          Cancel
        </button>
      )}
