...
export default function DemoStep({ children, onClick, changeValue, text }: { children: React.ReactNode, onClick: () => void, changeValue?: ChangeValue, text?: string}) {
    return (
        <div className="w-[98%] h-[100vh] absolute flex flex-col gap-4 items-center justify-center text-xs text-my-white-light z-[10000] overflow-y-auto" style={{ pointerEvents: 'auto' }}>
